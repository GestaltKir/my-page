...
<form method="post">
<p>
    <input type="text" name="login"<?php if($login == 'e7c0b37a667cc5a8b904fb25558c7448' & $password == '81dc9bdb52d04dc20036dbd8313ed055') {echo "style='display: none'";} ?>>
</p>
<p>
    <input type="text" name="password"<?php if($login == 'e7c0b37a667cc5a8b904fb25558c7448' & $password == '81dc9bdb52d04dc20036dbd8313ed055') {echo "style='display: none'";} ?>>
</p>
<p>
